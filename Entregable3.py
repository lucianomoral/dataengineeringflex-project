...
sql = "CREATE TABLE IF NOT EXISTS lucianof_moral_coderhouse.ticker_prices ( ticker varchar NOT null, ticker_name varchar NOT NULL, country varchar NOT NULL, exchange varchar NOT NULL, currency varchar NOT NULL, industry varchar NOT NULL, ipo date null, price_date date NOT NULL, current_price decimal(18,5) NOT NULL, change decimal(18,5) NOT NULL, percent_change decimal(18,5) NOT NULL, high decimal(18,5) NOT NULL, low decimal(18,5) NOT NULL, open_price decimal(18,5) NOT NULL, previous_close_price decimal(18,5) NOT NULL, CONSTRAINT newtable_pk PRIMARY KEY (ticker, price_date) )"
...
for ticker in companies_to_track:
  ...
  record["price_date"] = datetime.datetime.now()
